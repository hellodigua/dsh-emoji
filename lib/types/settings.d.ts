...
export declare function describeEmojiSettings(settings: Settings): EmojiSettingsDocument;
/**
 * 构造插件自有设置 RPC。它只暴露 dsh-emoji 命名空间，不借用或放宽
 * DSH core 的通用设置白名单；物理通道另由调用方限制为 loopback。
 */
export declare function createEmojiSettingsRpcHandler(settings: Settings, onCommitted?: (value: EmojiSettings) => void): ConnectionRpcHandler;
