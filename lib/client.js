	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			"mode.auto.description": "Use emoji naturally when a friendly response benefits, up to three per turn.",
			"mode.frequent.title": "Frequent",
			"mode.frequent.description": "Use emoji in multiple suitable places, up to four per turn.",
			...
			"limit.note": "Smart keeps up to 3 emoji per turn; Frequent keeps up to 4. Repeated emoji are allowed.",
		...
		const zh = {
			...
			"mode.auto.title": "智能",
			"mode.auto.description": "在友好回答适合表达情绪时自然使用，每回合最多三张。",
			"mode.frequent.title": "高频",
			"mode.frequent.description": "在日常回答的多个合适位置主动使用，每回合最多四张。",
			"pack.label": "表情包",
			"pack.builtin": "内置",
			...
			"limit.note": "智能模式每回合最多 3 张，高频模式最多 4 张；允许重复使用相同表情。",
